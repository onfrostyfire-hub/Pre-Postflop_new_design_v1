...
def get_spot_mastery_info(spot_data_dict):
    ...
    svg_basic = '<svg viewBox="0 0 100 100" style="width:100%;height:100%;opacity:0.15;"><path d="M50 20 C50 20 20 45 20 65 A15 15 0 0 0 50 85 A15 15 0 0 0 80 65 C80 45 50 20 50 20 Z" fill="#28a745"/></svg>'
    svg_solid = '<svg viewBox="0 0 100 100" style="width:100%;height:100%;opacity:0.15;"><path d="M15 15 L85 15 L85 45 C85 75 50 95 50 95 C50 95 15 75 15 45 Z" fill="none" stroke="#0dcaf0" stroke-width="6"/><path d="M50 30 C50 30 30 50 30 65 A10 10 0 0 0 50 80 A10 10 0 0 0 70 65 C70 50 50 30 50 30 Z" fill="#0dcaf0"/></svg>'
    svg_unexp = '<svg viewBox="0 0 100 100" style="width:100%;height:100%;opacity:0.15;"><path d="M10 10 L90 90 M90 10 L10 90" stroke="#6f42c1" stroke-width="6"/><path d="M20 20 L80 20 L80 50 C80 75 50 90 50 90 C50 90 20 75 20 50 Z" fill="#111" stroke="#6f42c1" stroke-width="4"/><path d="M50 35 C50 35 35 50 35 60 A8 8 0 0 0 50 70 A8 8 0 0 0 65 60 C65 50 50 35 50 35 Z" fill="#6f42c1"/></svg>'
    svg_elite = '<svg viewBox="0 0 100 100" style="width:100%;height:100%;opacity:0.15;"><path d="M10 20 L90 90 M90 20 L10 90" stroke="#dc3545" stroke-width="6"/><path d="M25 25 L75 25 L75 55 C75 80 50 95 50 95 C50 95 25 80 25 55 Z" fill="#111" stroke="#dc3545" stroke-width="4"/><path d="M50 40 C50 40 35 55 35 65 A8 8 0 0 0 50 75 A8 8 0 0 0 65 65 C65 55 50 40 50 40 Z" fill="#dc3545"/><path d="M30 20 L40 5 L50 15 L60 5 L70 20 L65 25 L35 25 Z" fill="#dc3545"/></svg>'
    svg_solver = '<svg viewBox="0 0 100 100" style="width:100%;height:100%;opacity:0.15;"><path d="M10 50 Q 10 10 45 10 Q 10 30 15 70 Z M90 50 Q 90 10 55 10 Q 90 30 85 70 Z" fill="#ffc107"/><path d="M5 25 L95 90 M95 25 L5 90" stroke="#ffc107" stroke-width="6"/><path d="M25 30 L75 30 L75 60 C75 85 50 100 50 100 C50 100 25 85 25 60 Z" fill="#111" stroke="#ffc107" stroke-width="4"/><path d="M50 45 C50 45 35 60 35 70 A8 8 0 0 0 50 80 A8 8 0 0 0 65 70 C65 60 50 45 50 45 Z" fill="#ffc107"/><path d="M30 25 L40 10 L50 20 L60 10 L70 25 L65 30 L35 30 Z" fill="#ffc107"/></svg>'
